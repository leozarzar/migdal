...
const StockPolicyUtils = {
    ...
    /**
     * Formata valor numérico com sufixo K/M para exibição compacta (2 casas decimais).
     * Distinguish from CanvasChartUtils.formatY que arredonda para eixo de gráfico.
     * @param {number} v
     * @returns {string}
     */
    formatValue(v) {
    ...
    /** @deprecated Use CanvasChartUtils.hexToRgba */
    hexToRgba: (hex, alpha) => CanvasChartUtils.hexToRgba(hex, alpha),

    /** @deprecated Use CanvasChartUtils.buildSmoothPath */
    buildSmoothPath: (ctx, pts) => CanvasChartUtils.buildSmoothPath(ctx, pts),
};
